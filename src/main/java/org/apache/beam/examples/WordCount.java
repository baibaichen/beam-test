...
import org.apache.beam.examples.oozie.OozieAuditLogParser;
...
//     .apply("WriteCounts", TextIO.Write.to(options.getOutput()));
    p.apply("ReadLines", TextIO.Read.from(options.getInputFile()))
            .apply(new OozieAuditLogParser.LogParser())
            .apply(MapElements.via(new OozieAuditLogParser.FormatAsTextFn()))
